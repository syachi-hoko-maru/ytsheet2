...
function checkFeats(){
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    if(level >= Number( array[i].replace(/[^0-9]/g, '') )){
      ...
      else if (feat.match(/妖術追加/)){
        if(lv['App'] < 1){ cL.add("error"); }
        if(feat.match(/Ⅰ$/)){
          if     (f3 && lv['App'] >= 13) { (auto) ? box.value = "妖術追加Ⅲ" : cL.add("mark") }
          else if(f2 && lv['App'] >=  7) { (auto) ? box.value = "妖術追加Ⅱ" : cL.add("mark") }
        }
        else if(feat.match(/Ⅱ$/)){
          if     (f3 && lv['App'] >= 13) { (auto) ? box.value = "妖術追加Ⅲ" : cL.add("mark") }
          else if(!f2 || lv['App'] <  7) { (auto) ? box.value = "妖術追加Ⅰ" : cL.add("error") }
        }
        else if(feat.match(/Ⅲ$/)){
          if     (!f2 || lv['App'] <  7) { (auto) ? box.value = "妖術追加Ⅰ" : cL.add("error") }
          else if(!f3 || lv['App'] < 13) { (auto) ? box.value = "妖術追加Ⅱ" : cL.add("error") }
        }
      }
      ...
      else if(feat === "妖術追加Ⅰ"){ feats['妖術追加'] = 1; }
      else if(feat === "妖術追加Ⅱ"){ feats['妖術追加'] = 2; }
      else if(feat === "妖術追加Ⅲ"){ feats['妖術追加'] = 3; }
