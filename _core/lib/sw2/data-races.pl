...
our %races = (
  ...
  'タビット' => {
    ...
    variantSort => ['パイカ種タビット','リパス種タビット','ルムナ種タビット'],
    variant => {
      'パイカ種タビット' => {
        ability => ['第六感','ホイッスル'],
  ...
  'ルーンフォーク' => {
    ...
    restrictedClass => ['プリースト','フェアリーテイマー','ドルイド', 'アパリシャー'],
  ...
  'ナイトメア' => {
    ...
    sin => 1,
    variantSort => ['人間','エルフ','ドワーフ','リルドラケン','シャドウ','ソレイユ', 'キシン'],
    variant => {
      '人間' => {
        ability => ['異貌','弱点／土'],
        language => [
      ...
      'キシン' => {
        ability => ['暴走','弱点／物理ダメージ'],
        language => [
          ['交易共通語', 1, 1 ],
        ],
        statusMod => { Str => 6, Int => -3, Mnd => -3, }
      }
    },
  },
  'リカント' => {
    ...
    variantSort => ['大型草食獣リカント','小型草食獣リカント','妖獣リカント'],
    variant => {
      '大型草食獣リカント' => {
      ...
      '妖獣リカント' => {
        ability => ['暗視(獣変貌)','獣変貌(妖獣)'],
        statusMod => { Str => -3, Int => +3, }
      }
    },
  },
  'リルドラケン' => {
  ...
  'マナフレア' => {
    ...
    restrictedClass => ['ソーサラー','コンジャラー','プリースト','フェアリーテイマー','マギテック','ドルイド','デーモンルーラー','グリモワール', 'ガーディナー'],
  },
  '魔動天使' => {
    type => '人族',
